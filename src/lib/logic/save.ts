...
class Pokemon {
    constructor(public index: number, public species: string, public originalTrainer: string, public name: string) {}
}
...
function readPokemonList(
    ...
    for (let i = 0; i < count; i++) {
        const index = readInteger(speciesData, i, 1)
        const species = pokemonMap[index]
